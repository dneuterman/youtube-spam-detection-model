...
def build_model():
    ...
    fig.tight_layout()
    plt.savefig(os.path.join(".", "static", "plots", "comments-classification-pie-chart.png"))
    plt.clf()
    ...
    def wordcloud_generator(word_freq_dict, wordcloud_filename):
        ...
        plt.axis("off")
        plt.savefig(os.path.join(".", "static", "plots", f"{wordcloud_filename}.png"))
        plt.clf()
    ...
    def word_freq_bar_chart_generator(word_freq_dict, chart_size, chart_filename):
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(".", "static", "plots", f"{chart_filename}.png"))
        plt.clf()
    ...
    def confusion_matrix_generator(classification_test, predicted_test):
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(".", "static", "plots", "test-prediction-cf-matrix.png"))
        plt.clf()
...
if __name__ == "__main__":
    ...
    command_parser.add_argument("execution", type=str, help="Initializes the raw data or builds the model")
    args = command_parser.parse_args()

    if args.execution == "init":
        init_model()
    if args.execution == "build":
        build_model()